...
const icons = {
	// AttachIcon: React.FC<SvgProps> = (props) => (
	attach: (props: SvgProps) => (
		<svg
	...
	doubleTick: (props: SvgProps) => (
		<svg
			xmlns="http://www.w3.org/2000/svg"
			viewBox="0 0 16 15"
			width="16"
			height="15"
			aria-label="double-tick"
			role="img"
			{...props}
		>
			<path
	...
	emojiActivity: (props: SvgProps) => (
		<svg
			xmlns="http://www.w3.org/2000/svg"
			viewBox="0 0 24 24"
			width="24"
			height="24"
			aria-label="emoji-activity"
			role="img"
			{...props}
		>
			<path
	...
	emojiFlags: (props: SvgProps) => (
		<svg
			xmlns="http://www.w3.org/2000/svg"
			viewBox="0 0 24 24"
			width="24"
			height="24"
			aria-label="emoji-flags"
			role="img"
			{...props}
		>
			<path
	...
	emojiFood: (props: SvgProps) => (
		<svg
			xmlns="http://www.w3.org/2000/svg"
			viewBox="0 0 24 24"
			width="24"
			height="24"
			aria-label="emoji-food"
			role="img"
			{...props}
		>
			<path
	...
	emojiNature: (props: SvgProps) => (
		<svg
			xmlns="http://www.w3.org/2000/svg"
			viewBox="0 0 24 24"
			width="24"
			height="24"
			aria-label="emoji-nature"
			role="img"
			{...props}
		>
			<path
	...
	emojiObjects: (props: SvgProps) => (
		<svg
			xmlns="http://www.w3.org/2000/svg"
			viewBox="0 0 24 24"
			width="24"
			height="24"
			aria-label="emoji-objects"
			role="img"
			{...props}
		>
			<path
	...
	emojiPeople: (props: SvgProps) => (
		<svg
			xmlns="http://www.w3.org/2000/svg"
			viewBox="0 0 24 24"
			width="24"
			height="24"
			aria-label="emoji-people"
			role="img"
			{...props}
		>
			<path
	...
	emojiTravel: (props: SvgProps) => (
		<svg
			xmlns="http://www.w3.org/2000/svg"
			viewBox="0 0 24 24"
			width="24"
			height="24"
			aria-label="emoji-travel"
			role="img"
			{...props}
		>
			<path
